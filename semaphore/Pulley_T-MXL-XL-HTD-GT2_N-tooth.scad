include <parametric-pulley-generator.scad>;
...
if ( profile == 1 ) { 
	pulley(
			belt_description          = "MXL"
			, pulley_OD               = calc_pulley_dia_tooth_spacing(teeth, 2.032, 0.254) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 0.508
			, tooth_width             = 1.321
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_MXL(height = pulley_t_ht);
}

if ( profile == 2 ) { 
	pulley(
			belt_description          = "40DP"
			, pulley_OD               = calc_pulley_dia_tooth_spacing(teeth, 2.07264, 0.1778) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 0.457
			, tooth_width             = 1.226 
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_40DP(height = pulley_t_ht);
}

if ( profile == 3) { 
	pulley(
			belt_description          = "XL"
			, pulley_OD               = calc_pulley_dia_tooth_spacing(teeth, 5.08, 0.254) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 1.27
			, tooth_width             = 3.051
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_XL(height = pulley_t_ht);
}

if ( profile == 4) { 
	pulley(
			belt_description          = "H"
			, pulley_OD               = calc_pulley_dia_tooth_spacing(teeth, 9.525, 0.381) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 1.905 
			, tooth_width             = 5.359 
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_H(height = pulley_t_ht);
}


if ( profile == 5) { 
	pulley(
			belt_description          = "T2.5"
			, pulley_OD               = calc_pulley_dia_tooth_spacing_curvefit (teeth, 0.7467,0.796,1.026) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 0.7
			, tooth_width             = 1.678
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_T2_5(height = pulley_t_ht);
}

if ( profile == 6) { 
	pulley(
			belt_description          = "T5"
			, pulley_OD               = calc_pulley_dia_tooth_spacing_curvefit (teeth, 0.6523,1.591,1.064) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 1.19
			, tooth_width             = 3.264
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_T5(height = pulley_t_ht);
}

if ( profile == 7) { 
	pulley(
			belt_description          = "T10"
			, pulley_OD               = calc_pulley_dia_tooth_spacing(teeth, 10, 0.93) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 2.5
			, tooth_width             = 6.13
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_T10(height = pulley_t_ht);
}

if ( profile == 8) { 
	pulley(
			belt_description          = "AT5"
			, pulley_OD               = calc_pulley_dia_tooth_spacing_curvefit (teeth, 0.6523,1.591,1.064) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 1.19
			, tooth_width             = 4.268
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_AT5(height = pulley_t_ht);
}

if ( profile == 9) { 
	pulley(
			belt_description          = "HTD 3mm"
			, pulley_OD               = calc_pulley_dia_tooth_spacing (teeth, 3, 0.381) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 1.289
			, tooth_width             = 2.27
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_HTD_3mm(height = pulley_t_ht);
}

if ( profile == 10) { 
	pulley(
			belt_description          = "HTD 5mm"
			...
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_HTD_5mm(height = pulley_t_ht);
}

if ( profile == 11) { 
	pulley(
			belt_description          = "HTD 8mm"
			, pulley_OD               = calc_pulley_dia_tooth_spacing (teeth, 8,0.6858) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 3.607 
			, tooth_width             = 6.603
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_HTD_8mm(height = pulley_t_ht);
}
...
if ( profile == 12) { 
	pulley(
			...
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_GT2_2mm(height = pulley_t_ht);
}


if ( profile == 13) { 
	pulley(
			belt_description          = "GT2 3mm"
			, pulley_OD               = calc_pulley_dia_tooth_spacing (teeth, 3,0.381) // Set the pulley diameter for a given number of teeth
			, teeth                   = teeth
			, tooth_depth             = 1.169
			, tooth_width             = 2.31
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_GT2_3mm(height = pulley_t_ht);
}
...
if ( profile == 14) { 
	pulley(
			...
			, additional_tooth_depth  = additional_tooth_depth
			, additional_tooth_width  = additional_tooth_width
			, motor_shaft             = NEMA17_SHAFT_DIA ) tooth_profile_GT2_5mm(height = pulley_t_ht);
}


/*
 * Tooth profile modules. Each item is unique to the belt teeth. 
 * (use ! in front of the linear_extrude) to see a single "tooth" profile block
 * and you will understand quickly how the pulleys are constructed.
 */
module tooth_profile_MXL(height)
{
...
module tooth_profile_40DP(height)
{
...
module tooth_profile_XL(height)
{
...
module tooth_profile_T2_5(height)
{
	linear_extrude(height=height+2) polygon([[-0.839258,-0.5],[-0.839258,0],[-0.770246,0.021652],[-0.726369,0.079022],[-0.529167,0.620889],[-0.485025,0.67826],[-0.416278,0.699911],[0.416278,0.699911],[0.484849,0.67826],[0.528814,0.620889],[0.726369,0.079022],[0.770114,0.021652],[0.839258,0],[0.839258,-0.5]]);
}

module tooth_profile_T5(height)
{
...
module tooth_profile_T10(height)
{
...
module tooth_profile_HTD_5mm(height)
{
...
module tooth_profile_HTD_8mm(height)
{
