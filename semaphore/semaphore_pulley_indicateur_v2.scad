...
pulley_b_ht = 2;		// pulley base height, standard = 8. Set to same as idler_ht if you want an idler but no pulley.
    ...
    difference() {
        union() {
            ...
            translate([-pulley_b_dia/2, 0, 0])
                cube([pulley_b_dia, pulley_length - pulley_b_dia/2, pulley_b_ht]);
        }
        
        // Bearing hole
        translate([0, 0, -1])
            cylinder(d=bearing_diameter, h=bearing_width/2+1, $fn=100);
